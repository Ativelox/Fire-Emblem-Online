 ...
 *
 */
public abstract class ATileSet<E extends ITile> implements IRequireResource<Image[]> {
    ...
    protected void generateTiles(Image[] tiles) {
        mRow = 0;
    ...
    protected void addRange(int from, int to, Image[] tiles, ETileType type) {
    ...
    protected abstract void put(int index, Image[] tiles, ETileType type);
