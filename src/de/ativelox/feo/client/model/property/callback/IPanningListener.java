...
public interface IPanningListener {
    /**
     * Gets called when the user panned on the x-Axis. When
     ...
     */
    void onPanX(double amount);

    /**
     * Gets called when the user panned on the y-Axis. When
