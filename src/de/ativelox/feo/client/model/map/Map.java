...
public class Map extends SpatialObject implements IRequireResource<Tile[][]>, IRenderable, IUpdateable, IMoveListener {
    ...
    protected final java.util.Map<Integer, IUnit> mUnitMapping;
	...
	return algo.shortestPath(this.getByPos(source.getX(), source.getY()),
		this.getByPos(destination.getX(), destination.getY()));
	...
	mUnitMapping.put(unit.getId(), unit);
    }
	...
	mUnitMapping.remove(unit.getId());
    }
